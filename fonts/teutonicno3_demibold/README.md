...
import (
  ...
  _ "github.com/gmlewis/go-fonts-t/fonts/teutonicno3_demibold"
)

func main() {
  // ...
  xPos, yPos, xScale, yScale := 0.0, 0.0, 1.0, 1.0
  message := "Sample from teutonicno3_demibold"
  render, err := fonts.Text(xPos, yPos, xScale, yScale, message, "teutonicno3_demibold", &fonts.Center)
  if err != nil {
    log.Fatal(err)
  }
