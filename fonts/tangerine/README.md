...
import (
  ...
  _ "github.com/gmlewis/go-fonts-t/fonts/tangerine"
)

func main() {
  // ...
  xPos, yPos, xScale, yScale := 0.0, 0.0, 1.0, 1.0
  message := "Sample from tangerine"
  render, err := fonts.Text(xPos, yPos, xScale, yScale, message, "tangerine", &fonts.Center)
  if err != nil {
    log.Fatal(err)
  }
