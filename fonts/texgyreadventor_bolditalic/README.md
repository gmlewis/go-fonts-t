...
import (
  ...
  _ "github.com/gmlewis/go-fonts-t/fonts/texgyreadventor_bolditalic"
)

func main() {
  // ...
  xPos, yPos, xScale, yScale := 0.0, 0.0, 1.0, 1.0
  message := "Sample from texgyreadventor_bolditalic"
  render, err := fonts.Text(xPos, yPos, xScale, yScale, message, "texgyreadventor_bolditalic", &fonts.Center)
  if err != nil {
    log.Fatal(err)
  }
