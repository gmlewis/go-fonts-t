...
import (
  ...
  _ "github.com/gmlewis/go-fonts-t/fonts/texgyreadventor_regular"
)

func main() {
  // ...
  xPos, yPos, xScale, yScale := 0.0, 0.0, 1.0, 1.0
  message := "Sample from texgyreadventor_regular"
  render, err := fonts.Text(xPos, yPos, xScale, yScale, message, "texgyreadventor_regular", &fonts.Center)
  if err != nil {
    log.Fatal(err)
  }
